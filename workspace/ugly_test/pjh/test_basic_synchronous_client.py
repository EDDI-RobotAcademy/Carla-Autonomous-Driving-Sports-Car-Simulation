...
class BasicSynchronousClient(object):
    ...
    def depth_camera_blueprint(self):
        ...
        #		depth_camera_bp = self.world.get_blueprint_library().find('sensor.camera.semantic_segmentation')
        depth_camera_bp = self.world.get_blueprint_library().find('sensor.camera.semantic_segmentation')
    ...
    def setup_depth_camera(self):
        ...
        depth_camera_transform = carla.Transform(carla.Location(x=0, z=2.0), carla.Rotation(pitch=0))
    ...
    def depth_render(self):
        if self.depth_image is not None:
            self.depth_image.convert(cc.CityScapesPalette)
