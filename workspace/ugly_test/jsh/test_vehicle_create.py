...
def game_loop(args):
    ...
    try:
        ...
        traffic_manager.ignore_signs_percentage(world.player, 100.0)
        traffic_manager.ignore_vehicles_percentage(world.player, 100.0)
        traffic_manager.ignore_lights_percentage(world.player, 100.0)
        traffic_manager.distance_to_leading_vehicle(world.player, 0.0)
